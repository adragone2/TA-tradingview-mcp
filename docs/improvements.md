...
| P2.2 | **Throwback modelling in `breakout_check`** — Bulkowski over 10,348 patterns: throwbacks 74% after high-volume upward breakouts; patterns perform better WITHOUT one 97% of the time. Add descriptive throwback-likelihood + "did the throwback hold" clause, citation attached. | in-progress | breakout_check reports it; docs cite the numbers |
