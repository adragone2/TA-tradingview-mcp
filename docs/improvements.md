...
| P2.6 | Gap classification (breakaway/runaway/exhaustion) as a descriptive detector; PIP/template matching (Leigh et al. bull flag) as an LMW-style second opinion. Only with noise floors. | in-progress | Research-grade; optional |
