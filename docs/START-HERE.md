...
|-------|-----------|------------|
| **TradingView MCP** (this repo) | 168 tools driving a live TradingView Desktop chart over CDP | Charts, levels, entries, drawings, Pine. **Trading.** |
...
- [tools-reference.md](tools-reference.md) — all 168 tools by group
