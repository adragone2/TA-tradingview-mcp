...
|-------|-----------|------------|
| **TradingView MCP** (this repo) | 147 tools driving a live TradingView Desktop chart over CDP | Charts, levels, entries, drawings, Pine. **Trading.** |
...
- [tools-reference.md](tools-reference.md) — all 147 tools by group
...
- [playbook.md](playbook.md) — strategies and patterns from the reference books, and what cannot yet be evaluated
