...
|-------|-----------|------------|
| **TradingView MCP** (this repo) | 169 tools driving a live TradingView Desktop chart over CDP | Charts, levels, entries, drawings, Pine. **Trading.** |
...
- [tools-reference.md](tools-reference.md) — all 169 tools by group
