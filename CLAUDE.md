...
118 MCP tools driving a live TradingView Desktop chart over CDP (port 9222), plus the Tactical Alpha API and a separate WRDS server.
...
| [docs/tools-reference.md](docs/tools-reference.md) | All 118 tools (generated — `node scripts/gen-tools-doc.js`) |
